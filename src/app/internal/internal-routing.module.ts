...
const routes: Routes = [
  {
    path: '', canActivate: [AuthGuardService], component: InternalComponent, children: [
      ...
      { path: INTERNAL_PATHS.EDIT_USER, component: EditUserComponent, pathMatch: 'full' },
      ...
      { path: INTERNAL_PATHS.EDIT_THERAPIST, component: EditTherapistComponent, pathMatch: 'full' },
